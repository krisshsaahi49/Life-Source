        ...
        return(
            ...
            <div className="container">
                ...
                <Slider ref={c => (this.slider = c)} className="event_team_slider" {...settings}>
                    <EventTeamItem image="#" name="Krishna Saahi Yavana" post="Backend Developer"/>
                    <EventTeamItem image="#" name="Chinmaie Tiyyagura" post="Frontend Developer"/>
                    <EventTeamItem image="#" name="Uma Sowmya Puppala" post="Database Adminstrator"/>
                </Slider>
            </div>
        </section>
        )
